...
export default function Scene() {
  ...
  return (
    <div className="relative w-full h-full">
      {isTutorialOpen && (
        <div className="absolute left-20 top-6 z-10 w-[280px] border border-slate-200 bg-white p-4 text-slate-700">
          <div className="flex items-start justify-between gap-3">
            <div>
              <h3 className="text-sm font-semibold text-slate-900">Viewer Tips</h3>
            ...
            <button
              ...
              className="p-1 text-slate-400 transition-colors hover:bg-slate-100 hover:text-slate-700"
          ...
          <button
            type="button"
            onClick={dismissTutorial}
            className="mt-4 bg-black px-3 py-2 text-xs font-medium text-white transition-colors hover:bg-slate-800"
          >
            Got it
          </button>
        </div>
      ...
      {/* Floating toolbar — top-left, single container with dividers */}
      <div className="absolute left-6 top-6 z-10 flex flex-col bg-white border border-slate-200">
        <button
          type="button"
          ...
          className={`flex h-11 w-11 items-center justify-center border-b border-slate-200 transition-colors ${
            isHandToolActive
              ? "bg-black text-white"
        ...
        <button
          ...
          onClick={resetCamera}
          className="flex h-11 w-11 items-center justify-center border-b border-slate-200 text-slate-700 transition-colors hover:bg-slate-100"
        >
          <svg
            viewBox="0 0 24 24"
            fill="none"
        ...
        >
          <span className="text-[19px] leading-none font-medium">?</span>
        </button>
      </div>
